...
var cubes,list,math,num,number,opposite,race,square,slice=[].slice;number=42,opposite=!0,opposite&&(number=-42),square=function(e){return e*e},list=[1,2,3,4,5],math={root:Math.sqrt,square:square,cube:function(e){return e*square(e)}},race=function(){var e,o;return o=arguments[0],e=2<=arguments.length?slice.call(arguments,1):[],print(o,e)},"undefined"!=typeof elvis&&null!==elvis&&alert("I knew it!"),cubes=function(){var e,o,r;for(r=[],e=0,o=list.length;e<o;e++)num=list[e],r.push(math.cube(num));return r}();var courses,dish,food,foods,i,j,k,l,len,len1,len2,math,ref;for(math={root:Math.sqrt,square:square,cube:function(e){return e*square(e)}},ref=["toast","cheese","wine"],j=0,len=ref.length;j<len;j++)food=ref[j],eat(food);for(courses=["greens","caviar","truffles","roast","cake"],i=k=0,len1=courses.length;k<len1;i=++k)dish=courses[i],menu(i+1,dish);for(foods=["broccoli","spinach","chocolate"],l=0,len2=foods.length;l<len2;l++)food=foods[l],"chocolate"!==food&&eat(food);
alert("ALERT Z main.js"),$("h2").after("<p>Skeleton's first paragraph. Feel free to change this message!</p>");
alert("alert z test1.js");
alert("alert z nic2.js");